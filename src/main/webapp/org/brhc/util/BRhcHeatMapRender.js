...
var BRhcHeatMapRender = function (jqContainer, options, isDeepSpec) {
...
BRhcHeatMapRender.prototype.theme = "theme-fin1"; // 主题

BRhcHeatMapRender.prototype.chart = function (group, persist) {
    var self = this;
...
BRhcHeatMapRender.prototype.changeSize = function (instance) {
