...
var BRhcBmapRender = function (jqContainer, options, isDeepSpec) {
...
BRhcBmapRender.prototype.theme = "theme-fin1"; // 主题

BRhcBmapRender.prototype.chart = function (group, persist) {
    var self = this;
...
BRhcBmapRender.prototype.changeSize = function (instance) {
