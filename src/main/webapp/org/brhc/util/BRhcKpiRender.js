var BRhcKpiRender = function (jqContainer, options) {
    this.container = jqContainer; // jquery object
    this.options = options;
};

BRhcKpiRender.prototype.html = function (persist) {
    var self = this;
...
BRhcKpiRender.prototype.realTimeTicket = function () {
    var self = this;
    return function (o) {
...
BRhcKpiRender.prototype.do = function () {
    var self = this;
    $(self.container).html(self.rendered());
};

BRhcKpiRender.prototype.template =
