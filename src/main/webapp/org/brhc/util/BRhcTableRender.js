var BRhcTableRender = function (jqContainer, options, drill) {
...
BRhcTableRender.prototype.resize = function (container) {
...
BRhcTableRender.prototype.do = function (tall, persist) {
    this.tall = tall;
