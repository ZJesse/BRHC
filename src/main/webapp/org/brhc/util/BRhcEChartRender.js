...
var BRhcEChartRender = function (jqContainer, options, isDeepSpec) {
...
BRhcEChartRender.prototype.theme = "theme-fin1"; // 主题

BRhcEChartRender.prototype.chart = function (group, persist) {
    var self = this;
...
BRhcEChartRender.prototype.changeSize = function (instance) {
...
BRhcEChartRender.prototype.addClick = function (chartConfig, relations, $state, $window) {
