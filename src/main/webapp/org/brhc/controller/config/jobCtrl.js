 ...
 */
brhc.controller('jobCtrl', function ($scope, $rootScope, $http, dataService, $uibModal, ModalUtils, $filter, $interval) {
    ...
    $scope.editJob = function (job) {
        $uibModal.open({
            templateUrl: 'org/brhc/view/config/modal/job/edit.html',
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.config = function () {
                    $uibModal.open({
                        templateUrl: 'org/brhc/view/config/modal/job/' + $scope.job.jobType + '.html',
                        windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
                        backdrop: false,
                        size: 'lg',
                        scope: $scope,
