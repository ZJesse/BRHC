 ...
 */
brhc.controller('datasetCtrl', function ($scope, $http, $state, $stateParams, dataService, $uibModal, ModalUtils, $filter, chartService, $timeout, uuid4) {
    ...
    $scope.custom = function (o) {
        ...
        $uibModal.open({
            templateUrl: 'org/brhc/view/config/modal/custom.html',
            windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
            backdrop: false,
            size: 'lg',
            controller: function ($scope, $uibModalInstance) {
