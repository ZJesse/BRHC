 ...
 */
'use strict';
brhc.controller('widgetCtrl', function ($scope, $state, $stateParams, $http, $uibModal, dataService, ModalUtils, updateService, $filter, chartService, $timeout) {
        ...
        $scope.editExp = function (col) {
            ...
            $uibModal.open({
                templateUrl: 'org/brhc/view/config/modal/exp.html',
                windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                scope: $scope,
...
// };
        ...
        $scope.getChartView = function () {
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
                return 'org/brhc/view/config/chart/' + $scope.curWidget.config.chart_type + '.html';
            }
        };

        $scope.getOptionsView = function () {
            var basePath = 'org/brhc/view/config/chart/options/';
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
        ...
        $scope.editFilter = function (setbackArr, setbackIdx) {
            $uibModal.open({
                templateUrl: 'org/brhc/view/dashboard/modal/param.html',
                windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                resolve: {
        ...
        $scope.editVFilter = function (o) {
            $uibModal.open({
                templateUrl: 'org/brhc/view/config/modal/vfilter.html',
                windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                controller: function ($scope, $uibModalInstance) {
        ...
        $scope.editFilterGroup = function (col) {
            var columnObjs = schemaToSelect($scope.schema);
            $uibModal.open({
                templateUrl: 'org/brhc/view/config/modal/filterGroup.html',
                windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
                backdrop: false,
                scope: $scope,
                controller: function ($scope, $uibModalInstance) {
