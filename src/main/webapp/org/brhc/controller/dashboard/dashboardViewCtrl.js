...
brhc.controller('dashboardViewCtrl', function ($timeout, $rootScope, $scope, $state, $stateParams, $http, ModalUtils, chartService, $interval, $uibModal, dataService) {
    ...
    var paramToFilter = function () {
        ...
        if(location.href.split("?")[1]) {
            if(location.href.split("?")[1].indexOf("u=")<0){
    ...
    $scope.modalChart = function (widget) {
        $uibModal.open({
            templateUrl: 'org/brhc/view/util/modal/chart.html',
