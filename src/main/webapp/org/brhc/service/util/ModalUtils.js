...
brhc.service('ModalUtils', function ($uibModal, $filter) {

    var translate = $filter('translate');

    this.alert = function (content, style, size, callback) {
        $uibModal.open({
            templateUrl: 'org/brhc/view/util/modal/alert.html',
    ...
    this.confirm = function (content, style, size, ok, close) {
        $uibModal.open({
            templateUrl: 'org/brhc/view/util/modal/confirm.html',
            windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
            backdrop: false,
            windowClass: style,
            size: size,
    ...
    this.info = function (content, style, size, ok, close) {
        $uibModal.open({
            templateUrl: 'org/brhc/view/util/modal/information.html',
            windowTemplateUrl: 'org/brhc/view/util/modal/window.html',
            backdrop: false,
            windowClass: style,
            size: size,
