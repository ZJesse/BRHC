 ...
 */
'use strict';
brhc.service('chartHeatMapTableService', function () {
    ...
    this.render = function (containerDom, option, scope, persist) {
        ...
        return new BRhcEChartRender(containerDom, option).chart(height, persist);
    };
        ...
        var option = {
            tooltip: {
                ...
                formatter: function (params) {
                    return 'x ' + brhcTranslate("CONFIG.WIDGET.VALUE_AXIS") + ': ' + xAxisData[params.value[0]] +
                        '<br/>y ' + brhcTranslate("CONFIG.WIDGET.VALUE_AXIS") + ': ' + yAxisData[params.value[1]] +
                        '<br/>' + brhcTranslate("COMMON.VALUE") + ': ' + params.value[2];
                }
            },
            animation: false,
            toolbox: {
