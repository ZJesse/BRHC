...
import org.brhc.dao.RoleDao;
import org.brhc.dao.UserDao;
import org.brhc.dto.User;
import org.brhc.pojo.DashboardUser;
...
//		DashboardUser duser = userDao.getUserByCode(username);
		...
		User user = new User(duser.getLoginName(), "123123", true, true, true, true,
