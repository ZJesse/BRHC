...
import org.brhc.security.service.LocalSecurityFilter;
    ...
    public PersistContext persist(Long dashboardId, String userId) {
        ...
        try {
            if (boardDao.getBoard(dashboardId) == null) {
                throw new BrhcException(String.format("Dashbaord ID [%s] doesn't exist!", dashboardId));
            }
            ...
            throw new BrhcException(e.getMessage());
        }
    }
