...
import org.brhc.dao.BoardDao;
import org.brhc.dao.WidgetDao;
import org.brhc.dto.ViewDashboardBoard;
import org.brhc.dto.ViewDashboardWidget;
import org.brhc.pojo.DashboardBoard;
import org.brhc.pojo.DashboardWidget;
import org.brhc.services.persist.PersistContext;
import org.brhc.services.persist.excel.XlsProcessService;
    ...
    public ViewDashboardBoard getBoardData(Long id) {
        ...
        for (Object row : rows) {
            ...
            for (Object w : widgets) {
                ...
                try {
                    ViewDashboardWidget aa = new ViewDashboardWidget(widget);
                    JSONObject widgetJson = (JSONObject) JSONObject.toJSON(aa);
