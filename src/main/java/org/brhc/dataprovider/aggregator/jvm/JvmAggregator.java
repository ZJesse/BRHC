...
import org.brhc.util.NaturalOrderComparator;
...
import static org.brhc.dataprovider.DataProvider.separateNull;
...
public class JvmAggregator extends InnerAggregator {
    ...
    public String[] getColumn() throws Exception {
        ...
        try {
            ...
            throw new BrhcException("dataset is null");
        }
    }
