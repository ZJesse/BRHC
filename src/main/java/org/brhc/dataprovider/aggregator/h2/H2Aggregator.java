...
import static org.brhc.dataprovider.util.SqlHelper.surround;
...
public class H2Aggregator extends InnerAggregator {
    ...
    public AggregateResult queryAggData(AggConfig config) throws Exception {
        ...
        try (
            ...
            stat.execute("CREATE ALIAS IF NOT EXISTS f_todouble FOR \"org.brhc.dataprovider.aggregator.h2.Functions.parserString2Double\" ");
